...
ImGuiStyle::ImGuiStyle()//BresoDEV
{
    Alpha                   = 1.0f;             // Transparencia da janela
    WindowPadding           = ImVec2(0,0);      // Espacamento entre o elemento e a borda da janela
    WindowRounding          = 0.0f;             //Borda aredondada
    WindowBorderSize        = 1.0f;             
    WindowMinSize           = ImVec2(32,32);    
    WindowTitleAlign        = ImVec2(0.5f,0.5f);//Titulo centralizado 0.5
    WindowMenuButtonPosition= ImGuiDir_None; //Iconezinho que fica no titulo
    ChildRounding           = 0.0f;             
    ChildBorderSize         = 1.0f;             
    PopupRounding           = 0.0f;             
    PopupBorderSize         = 1.0f;             
    FramePadding            = ImVec2(4,3);      //Nao sei oq faz, mas anotei pra fica 0,4
    FrameRounding           = 0.0f;             
    FrameBorderSize         = 0.0f;             
    ItemSpacing             = ImVec2(0.9,0.9);      //Espacamento entre itens (ver com mais coisas no tool)
    ItemInnerSpacing        = ImVec2(4,4);      
    TouchExtraPadding       = ImVec2(0,0);      
    IndentSpacing           = 0.0f;            //Espacamento, tem que ver com mais itens como fica
